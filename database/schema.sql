...
-- SQLite dialect. The backend creates `homework-tracker.db` from this file
-- on first run, then loads seed.sql when the database is empty.
...
CREATE TABLE IF NOT EXISTS notifications (
  id TEXT PRIMARY KEY,
  -- Recipient user id, or 'all' for a class-wide announcement.
...
-- Academic assignments (class-level) and per-student submissions.
